describe("payments test (with set up and tear down)", function(){
    ...
    it('should add a new payment to allPayments on submitPaymentInfo()', function(){
        ...
        expect(allPayments['payment1'].tipPrecent).toEqual(20);
    });
    ...
    it('should create a new payment on createOurPayment()',function(){
        let expectedPayment = {
            billAmt: '100',
            tipAmt: '20',
            tipPrecent: 20,
    ...
    it('should not create payment with empty input on createOurPayment()',function(){
        billAmtInput.value = '';
        tipAmtInput.value = '';
        let curPayment = createCurPayment();
