describe("utilities test(with setup and tear down)", function(){
    ...
    it('should sum tip percent of a singlen tip on calculateTipPercent()', function(){
        expect(calculateTipPercent(100, 23)).toEqual(23);
        expect(calculateTipPercent(111, 11)).toEqual(10);
    });

    it('should generate new td from value and append it to tr on appendTd(tr,value)', function(){
